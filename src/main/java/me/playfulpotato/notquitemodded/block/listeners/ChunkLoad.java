...
public class ChunkLoad implements Listener {
    ...
    public void onChunkLoad(ChunkLoadEvent event) {
        ...
        NotQuiteModded.blockDatabase.TableExistsOffChunk(loadedChunk).thenAccept(exists -> {
            if (!exists)
                return;

            NotQuiteModded.blockDatabase.RetrieveAllBlockDataInChunk(loadedChunk).thenAccept(blockData -> {
